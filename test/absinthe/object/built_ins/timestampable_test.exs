defmodule Absinthe.Object.BuiltIns.TimestampableTest do
  use ExUnit.Case, async: true

  alias Absinthe.Object.BuiltIns.Timestampable

  describe "interface definition" do
    test "defines __absinthe_object_definition__/0" do
      definition = Timestampable.__absinthe_object_definition__()
    ...
    test "defines __absinthe_object_identifier__/0" do
      assert Timestampable.__absinthe_object_identifier__() == :timestampable
    end

    test "defines __absinthe_object_kind__/0" do
      assert Timestampable.__absinthe_object_kind__() == :interface
    end
  end
