defmodule Absinthe.Object.Deferred.Interface do
  @moduledoc """
  Deferred GraphQL interface definition.

  Like `Absinthe.Object.Deferred.Type`, this stores definitions as pure data
  ...
  defmacro __using__(_opts) do
    quote do
      import Absinthe.Object.Deferred.Interface, only: [interface: 2, interface: 3]
      ...
      @before_compile Absinthe.Object.Deferred.Interface
    end
  end
  ...
  defmacro interface(name, opts \\ [], do: block) do
    quote do
      ...
      import Absinthe.Object.Deferred.Interface, only: [field: 2, field: 3]
  ...
  defmacro __before_compile__(env) do
    ...
    identifier = Absinthe.Object.Naming.to_identifier(interface_def[:name])
